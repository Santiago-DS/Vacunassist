...
INSERT INTO `historiaclinica` VALUES (8,1,'2022-07-04',1,'2022-07-07 16:12:50','2022-07-07 16:12:50',NULL,NULL),(9,1,'2021-11-07',1,'2022-07-07 16:13:24','2022-07-07 16:13:24',NULL,NULL),(10,1,'2022-03-03',3,'2022-07-07 17:24:40','2022-07-07 17:24:40',NULL,NULL),(11,5,'2022-07-07',1,'2022-07-07 17:34:27','2022-07-07 17:34:27',NULL,NULL);
...
CREATE TABLE `laboratorios` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `nombreLaboratorio` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `turnos` (
  ...
  `fecha` date NOT NULL,
  `hora` date NOT NULL,
  `estado` enum('aplicado','cancelado','ausente','pendiente','aprobacion') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pendiente',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `turnos` VALUES (5,1,1,1,'2022-07-07','2022-07-07','aplicado','2022-07-07 16:41:21','2022-07-07 16:43:07'),(6,3,2,1,'2022-07-07','2022-07-07','aplicado','2022-07-07 16:41:24','2022-07-07 16:49:06'),(7,2,3,1,'2022-07-07','2022-07-07','aplicado','2022-07-07 16:41:21','2022-07-07 16:43:07'),(8,2,3,1,'2022-07-07','2022-07-07','aplicado','2022-07-07 16:41:21','2022-07-07 16:43:07'),(9,1,2,1,'2022-07-07','2022-07-07','aplicado','2022-07-07 16:41:21','2022-07-07 16:43:07'),(10,1,2,1,'2022-07-11','2022-07-07','cancelado','2022-07-07 17:25:15','2022-07-07 17:25:23'),(11,2,1,1,'2022-07-30','2022-07-07','cancelado','2022-07-07 17:27:26','2022-07-07 17:30:06'),(13,2,1,1,'2022-07-30','2022-07-07','cancelado','2022-07-07 17:32:05','2022-07-07 17:32:46'),(14,2,1,1,'2022-07-11','2022-07-07','aprobacion','2022-07-07 17:33:01','2022-07-07 17:33:01'),(15,1,2,5,'2022-07-21','2022-07-07','pendiente','2022-07-07 17:34:27','2022-07-07 17:34:27'),(16,3,1,5,'2022-07-27','2022-07-07','pendiente','2022-07-07 17:39:14','2022-07-07 17:39:14'),(17,2,1,5,'2022-07-11','2022-07-07','aprobacion','2022-07-07 17:57:52','2022-07-07 17:57:52');
...
CREATE TABLE `users` (
  ...
  `fecha_nacimiento` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `rol` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'paciente',
...
INSERT INTO `users` VALUES (1,'Juan','paciente@gmail.com',NULL,'$2y$10$CKBxsaGKWZzf19whpvtcReP8DTODc68s5vdHOumwx0ImJw3wKThg2',NULL,'2022-06-28 23:55:15','2022-06-28 23:55:15','Perez','Calle 59','2216542727','54672788','1990-06-16','paciente',NULL),(2,'Doctor','enfermero@gmail.com',NULL,'$2y$10$9zY6YF74MSOF/yclkzHxxOm19YdTi4IxZabEHhNSXgGaHNCddNUyi',NULL,'2022-06-28 23:58:06','2022-07-07 16:27:55','Perez','1','1','4567788','2000-06-22','enfermero',1),(3,'Admin','admin@gmail.com',NULL,'$2y$10$khw.mIP4HAaMCZSFFLTZY.q/t5vFYzdjk8cktty8y7eWhPPhh/QgW',NULL,'2022-06-28 23:59:44','2022-06-28 23:59:44','Admin','1','1','1345','2022-06-28','administrativo',NULL),(5,'Sofia','otropaciente@gmail.com',NULL,'$2y$10$Jqo4qofBe4FVoJyao3DdAOdKYhFk0ICXFHgY4ncErQYpxf5GNgcoy',NULL,'2022-07-07 17:34:16','2022-07-07 17:34:16','Othaz','Calle 25','2216542726','76534847','2020-07-11','paciente',NULL);
...
CREATE TABLE `vacunas` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `nombreVacuna` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `vacunas` VALUES (1,'COVID',NULL,NULL,1),(2,'Fiebre Amarilla',NULL,NULL,1),(3,'Gripe',NULL,NULL,1),(4,'Sarampion','2022-07-07 16:35:40','2022-07-07 16:36:58',0);
...
CREATE TABLE `zonas` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `nombreZona` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `zonas` VALUES (1,'Cementerio Municipal',NULL,NULL),(2,'Municipalidad',NULL,NULL),(3,'Terminal Omnibus',NULL,NULL);
...
-- Dump completed on 2022-07-07 12:01:16
