                ...
                <nav class="navbar navbar-expand navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column" style="border: none">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-5" aria-controls="submenu-5"><i class="fas fa-fw fa-file"></i>Gestion de Administracion</a>
                                <div id="submenu-5" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="aprobacion-turnos">Aprobación de Turnos</a>
                                        </li>
                                    </ul>
                                </div>
                                <a class="nav-link" href="reportes"><i class="fas fa-fw fa-table"></i>Reportes</a>
