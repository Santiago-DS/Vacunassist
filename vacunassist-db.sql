...
CREATE TABLE `turnos` (
  ...
  `fecha` date NOT NULL,
  `hora` date NOT NULL,
  `estado` enum('aplicado','cancelado','ausente','pendiente','aprobacion') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pendiente',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `vacunas` VALUES (1,'COVID',NULL,NULL,1),(2,'Fiebre Amarilla',NULL,NULL,1),(3,'Gripe',NULL,NULL,1);
...
-- Dump completed on 2022-06-28 18:21:02
